using HaftalikDersProgrami.Base_Class;
...
namespace HaftalikDersProgrami
{
    public partial class Ogretmenler : Form
    {
        ...
        void addListe(int id, string name, string surname, string unvan, string[] gunler)
        {
            bunifuDataGridView1.Rows.Add();
            try
            {
                bunifuDataGridView1.Rows[bunifuDataGridView1.Rows.Count - 1].Cells[0].Value = id;
                bunifuDataGridView1.Rows[bunifuDataGridView1.Rows.Count - 1].Cells[1].Value = name;
                bunifuDataGridView1.Rows[bunifuDataGridView1.Rows.Count - 1].Cells[2].Value = surname;
                bunifuDataGridView1.Rows[bunifuDataGridView1.Rows.Count - 1].Cells[3].Value = unvan;
                string rawText = "";
                ...
                bunifuDataGridView1.Rows[0].Cells[0].Value = id;
                bunifuDataGridView1.Rows[0].Cells[1].Value = name;
                bunifuDataGridView1.Rows[0].Cells[2].Value = surname;
                bunifuDataGridView1.Rows[0].Cells[3].Value = unvan;
                string rawText = "";
                foreach (string s in gunler)
                {
                    rawText += s + ",";
                ...
                bunifuDataGridView1.Rows[0].Cells[4].Value = rawText;
            }
        }
        ...
        void listele()
        {
            ...
            {
                addListe(t.id, t.name, t.surname, t.unvan, GunManager.GetGuns(t.musaitGunler));
            }
        }
        ...
        {
            OgretmenManager.removeOgretmen(int.Parse(bunifuDataGridView1.SelectedRows[0].Cells[0].Value.ToString()));
            bunifuDataGridView1.Rows.Remove(bunifuDataGridView1.SelectedRows[0]);
        }
    }
}
