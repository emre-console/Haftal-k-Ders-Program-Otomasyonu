...
namespace HaftalikDersProgrami
{
    public partial class Dersler : Form
    {
        ...
        void addListe(int id, string dersName, string dersKod, string[] tId, string saat)
        {
            dataList.Rows.Add();
            try
            {
                dataList.Rows[dataList.Rows.Count - 1].Cells[0].Value = id;
                dataList.Rows[dataList.Rows.Count - 1].Cells[1].Value = dersName;
                dataList.Rows[dataList.Rows.Count - 1].Cells[2].Value = dersKod;
                dataList.Rows[dataList.Rows.Count - 1].Cells[4].Value = saat;
                ...
                dataList.Rows[0].Cells[0].Value = id;
                dataList.Rows[0].Cells[1].Value = dersName;
                dataList.Rows[0].Cells[2].Value = dersKod;
                dataList.Rows[0].Cells[4].Value = saat;
                ...
                rawData = rawData.Substring(0, rawData.Length - 1);
                dataList.Rows[0].Cells[3].Value = rawData;
        ...
        void setupDataGrid()
        {
            ...
            {
                addListe(s.id, s.name, s.dersKod, Managers.OgretmenManager.GetTeacherNameWithId(s.teachers), s.saat.ToString());
            }
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Managers.ClassManager.RemoveClass(int.Parse(dataList.SelectedRows[0].Cells[0].Value.ToString()));
            dataList.Rows.Remove(dataList.SelectedRows[0]);
