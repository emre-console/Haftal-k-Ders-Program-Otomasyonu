...
namespace HaftalikDersProgrami
{
    public partial class Derslikler : Form
    {
        ...
        void addListe(int id, string name, string type, string kapasite)
        {
            bunifuDataGridView1.Rows.Add();
            try
            {
            ...
            catch (ArgumentOutOfRangeException)
            {
                ...
                bunifuDataGridView1.Rows[0].Cells[2].Value = type;
                bunifuDataGridView1.Rows[0].Cells[3].Value = kapasite;
            }
        }
        ...
        void listele()
        {
            ...
            {
                addListe(s.id, s.name, s.dersTip.ToString(), s.kapasite.ToString());
            }
            GC.Collect();
        }
        ...
        {
            DerslikManager.removeDerslik(int.Parse(bunifuDataGridView1.SelectedRows[0].Cells[0].Value.ToString()));
